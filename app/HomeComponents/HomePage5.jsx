...
export default function HomePage5() {
  return (
    <div className="w-full min-h-screen bg-[#f7fdff] flex justify-center items-center">
      <div className="w-[90%] max-w-[1200px] h-[70vh] flex gap-8">
        {/* Image Section */}
        <div className="images h-full w-[40%] rounded-4xl overflow-hidden">
          <img
        ...
        {/* Text Section */}
        <div className="h-full w-[60%] flex flex-col justify-around gap-6">
          <div className="flex flex-col justify-center gap-6">
            <h1 className="text-5xl font-sans font-bold text-[#1a1a1a]">
              We believe in{" "}
              <span className="text-blue-500">Empowering Innovations</span>{" "}
              through Technology
            </h1>
            <p className="text-gray-600 text-md w-[80%] leading-relaxed">
              Focused on SEO, social media, and content strategies to boost
              brand visibility, engage audiences, and drive business growth.
            </p>
            <button className="bg-blue-500 w-fit items-center flex gap-2 text-white pl-2 pr-7 text-xl py-2 rounded-full hover:bg-blue-600 transition">
              <img
                width="40"
                height="40"
          ...
          <div className="flex relative gap-15 mt-6 before:content[('')] before:absolute before:top-[-20px] before:w-full before:h-[1px] before:bg-gray-400">
            <div className="flex flex-col relative after:content[('')] after:absolute after:right-[-30px] after:h-full after:w-[1px] after:bg-gray-400">
              <span className="text-5xl font-bold text-blue-500">25+</span>
              <span className="text-gray-600">Years in digital marketing</span>
            </div>
